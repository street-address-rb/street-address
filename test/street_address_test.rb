...
class StreetAddressTest < Minitest::Test
  ADDRESSES = {
    "1005 Gravenstein Hwy 95472" => {
      number: "1005", street: "Gravenstein", postal_code: "95472", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy, 95472" => {
      number: "1005", street: "Gravenstein", postal_code: "95472", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy N, 95472" => {
      number: "1005", street: "Gravenstein", postal_code: "95472", suffix: "N", street_type: "Hwy"
    },
    "1005 Gravenstein Highway North, 95472" => {
      number: "1005", street: "Gravenstein", postal_code: "95472", suffix: "N", street_type: "Hwy"
    },
    "1005 N Gravenstein Highway, Sebastopol, CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "Sebastopol", street_type: "Hwy", prefix: "N"
    },
    ...
    "1005 N Gravenstein Highway, Reno, NV, 95472" => {
      number: "1005", street: "Gravenstein", state: "NV", city: "Reno", postal_code: "95472", street_type: "Hwy", prefix: "N"
    },
    "1005 N Gravenstein Highway Reno NV 95472" => {
      number: "1005", street: "Gravenstein", state: "NV", city: "Reno", postal_code: "95472", street_type: "Hwy", prefix: "N"
    },
    "1005 Gravenstein Hwy N Sebastopol CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "Sebastopol", suffix: "N", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy N, Sebastopol CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "Sebastopol", suffix: "N", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy, N Sebastopol CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "North Sebastopol", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy, North Sebastopol CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "North Sebastopol", street_type: "Hwy"
    },
    "1005 Gravenstein Hwy Sebastopol CA" => {
      number: "1005", street: "Gravenstein", state: "CA", city: "Sebastopol", street_type: "Hwy"
    },
    "115 Broadway San Francisco CA" => {
      street_type: nil, number: "115", street: "Broadway", state: "CA", city: "San Francisco"
    },
    "7800 Mill Station Rd, Sebastopol, CA 95472" => {
      number: "7800", street: "Mill Station", state: "CA", city: "Sebastopol", postal_code: "95472", street_type: "Rd"
    },
    "7800 Mill Station Rd Sebastopol CA 95472" => {
      number: "7800", street: "Mill Station", state: "CA", city: "Sebastopol", postal_code: "95472", street_type: "Rd"
    },
    "1005 State Highway 116 Sebastopol CA 95472" => {
      number: "1005", street: "State Highway 116", state: "CA", city: "Sebastopol", postal_code: "95472", street_type: "Hwy"
    },
    "1600 Pennsylvania Ave. Washington DC" => {
      number: "1600", street: "Pennsylvania", state: "DC", city: "Washington", street_type: "Ave"
    },
    "1600 Pennsylvania Avenue Washington DC" => {
      number: "1600", street: "Pennsylvania", state: "DC", city: "Washington", street_type: "Ave"
    },
    "48S 400E, Salt Lake City UT" => {
      street_type: nil, number: "48", street: "400", state: "UT", city: "Salt Lake City", suffix: "E", prefix: "S"
    },
    ...
    "100 South St, Philadelphia, PA" => {
      number: "100", street: "South", state: "PA", city: "Philadelphia", street_type: "St"
    },
    ...
    "lt42 99 Some Road, Some City LA" => { # no space before sec_unit_num
      unit: "42", city: "Some City", number: "99", street: "Some", unit_prefix: "Lt", street_type: "Rd", state: "LA"
    },
    "36401 County Road 43, Eaton, CO 80615" => { # numbered County Road
      city: "Eaton", postal_code: "80615", number: "36401", street: "County Road 43", street_type: "Rd", state: "CO"
    },
    ...
    "45 Quaker Ave, Ste 105" => { # RT#73397
      number: "45", street: "Quaker", street_type: "Ave", unit: "105", unit_prefix: "Ste"
    },
  ...
  INFORMAL_ADDRESSES = {
    ...
    "321 S. Washington" => {
      street_type: nil, prefix: "S", street: "Washington", number: "321"
    },
    "233 S Wacker Dr lobby 60606" => {
      number: "233", street: "Wacker", postal_code: "60606", street_type: "Dr", prefix: "S", unit_prefix: "Lobby"
    },
    "(233 S Wacker Dr lobby 60606)" => {
      number: "233", street: "Wacker", postal_code: "60606", street_type: "Dr", prefix: "S", unit_prefix: "Lobby"
    },
  ...
  def test_address_parsing
    ADDRESSES.each_pair do |address, expected|
      addr = StreetAddress.parse(address)
  ...
  def test_informal_address_parsing
    INFORMAL_ADDRESSES.each_pair do |address, expected|
      addr = StreetAddress.parse(address, informal: true)
      compare_expected_to_actual_hash(expected, addr.to_h, address)
    end
  end
  ...
  def test_expected_failures
    EXPECTED_FAILURES.each do |address|
      parsed_address = StreetAddress.parse(address)
  ...
  def test_street_type_is_nil_for_road_redundant_street_types
    ...
    parsed_address = StreetAddress.parse(address, avoid_redundant_street_type: true)
    compare_expected_to_actual_hash(expected_results, parsed_address.to_h, address)
  end

  def test_zip_plus_4_with_dash
    addr = StreetAddress.parse("2730 S Veitch St, Arlington, VA 22206-3333")
    assert_equal "3333", addr.postal_code_ext
  end

  def test_zip_plus_4_without_dash
    addr = StreetAddress.parse("2730 S Veitch St, Arlington, VA 222064444")
    assert_equal "4444", addr.postal_code_ext
  end

  def test_informal_parse_normal_address
    a = StreetAddress.parse("2730 S Veitch St, Arlington, VA 222064444", informal: true)
  ...
  def test_informal_parse_informal_address
    a = StreetAddress.parse("2730 S Veitch St", informal: true)
    assert_equal "2730", a.number
    assert_equal "S", a.prefix
    assert_equal "Veitch", a.street
    assert_equal "St", a.street_type
  ...
  def test_informal_parse_informal_address_trailing_words
    a = StreetAddress.parse("2730 S Veitch St in the south of arlington", informal: true)
    assert_equal "2730", a.number
    assert_equal "S", a.prefix
    assert_equal "Veitch", a.street
    assert_equal "St", a.street_type
  ...
  def compare_expected_to_actual_hash(expected, actual, address)
    expected.each_pair do |expected_key, expected_value|
      if expected_value.nil?
        assert_nil(actual[expected_key], "For address #{address}, #{actual[expected_key]} != #{expected_value}")
        next
      end
      assert_equal(
        expected_value,
        actual[expected_key],
        "For address #{address}, #{actual[expected_key]} != #{expected_value}"
      )
    end
  end
end
